...
import { Calendar, BookOpen, Layers, FileText, ArrowRight, Sparkles } from 'lucide-react'; // ← added Sparkles
import Link from 'next/link';
import { Button } from '@/components/ui/button';
import Image from 'next/image';
import placeholderData from '@/lib/placeholder-images.json';
                                              ...
                                              <li key={article.slug}>
                                                <Link href={`/articles/${article.slug}`} className="flex items-center gap-2 text-muted-foreground hover:text-primary hover:underline group">
                                                  ...
                                                  <span className="flex items-center gap-2">
                                                    {article.title}
                                                    {article.tags?.includes("special-activity") && (
                                                      <Badge variant="outline" className="bg-accent/20 text-accent border-accent text-xs font-medium flex items-center gap-1">
