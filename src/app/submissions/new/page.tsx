...
//                            <div className="border-4 border-dashed border-border rounded-xl p-8 text-center bg-muted/50 transition-colors hover:border-primary hover:bg-primary/10">
...
//                               <Button type="button" variant="outline">Or Browse Files</Button>
//                           </div>
